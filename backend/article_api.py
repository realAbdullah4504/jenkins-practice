...
# @cross_origin()
# def index():
#     return jsonify({"message": "News-app Server is running"})
...
# @app.route('/react/signup')
# @app.route('/react/login')
# @app.route('/react/settings')
# @app.route('/react/reset_password/<string:key>')  # Use angle brackets for dynamic parts
