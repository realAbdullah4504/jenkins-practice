	...
	html: `<html>
            ...
            <body>
              <div class="container">
                ...
                <p class="desc">Tu perfil de Craftsman ha sido creado con éxito. Para activar tu cuenta y acceder a todas las funciones, haz clic en el siguiente enlace de registro:</p>
            
                <a
                  href="${baseUrl}/api/verify_email/?email=${email}&id=${password}&handyman=true&craftsmanId=${craftsmanId}"
                ...
                <p class="desc1">Después de la activación, tendrás los siguientes detalles de inicio de sesión:</p>
                </br>
                <p class="">Dirección de correo electrónico: ${email}</p>
                <p class="">Contraseña: ${password}</p>
                </br> </br>
                <p class="desc">Por favor, mantén tus detalles de inicio de sesión seguros y no los compartas con otros. Después de la activación, puedes usar esta información para iniciar sesión en el Portal de Servicios Handyman.</p>
